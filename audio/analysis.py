...
vectors, filenames = aF.dirWavFeatureExtraction('/Volumes/Seagate Expansion Drive/AudioFiler/batches/batch_9', 60, 30, 1, 1)
...
np.savetxt("/Volumes/Seagate Expansion Drive/AudioFiler/batches/batch_9.txt", arr2)
